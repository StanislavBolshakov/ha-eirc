...
* **eirc:** ошибка в обновлении данных одной учетной записи теперь не ведет к ошибки операции обновления целиком ([f2c766a](https://github.com/StanislavBolshakov/ha-eirc/commit/f2c766a2fc60afe1d939e018e0ffd962791e9cdf))
...
* **EIRC:** новогодний FEATURE DROP 🎄 🎁 Добавлен сервис получения счета в PDF для учетной записи ([d36b7c2](https://github.com/StanislavBolshakov/ha-eirc/commit/d36b7c2015874752d5fcb27d6eeaf02f605b91a8))

## [1.1.4](https://github.com/StanislavBolshakov/ha-eirc/compare/v1.1.3...v1.1.4) (2025-11-15)


### Bug Fixes

* **EIRC:** исправления re-auth flow, если сессия была удалена из личного кабинета. ([7d357f6](https://github.com/StanislavBolshakov/ha-eirc/commit/7d357f6b492657fed6296cf434b7e29f40a82a54))
* **EIRC:** ошибочное удаление verify token при обработке 401 ошибок ([3cdd9ed](https://github.com/StanislavBolshakov/ha-eirc/commit/3cdd9eda31293834d9e5cdfc74383aec3e982de9))
...
## [1.1.3](https://github.com/StanislavBolshakov/ha-eirc/compare/v1.1.2...v1.1.3) (2025-11-08)


### Bug Fixes

* **EIRC:** исправлена ссылки на несуществующие шаблоны ([e9eb097](https://github.com/StanislavBolshakov/ha-eirc/commit/e9eb0971edd8726a3ad22c4a9dda43c139e9f26b))
